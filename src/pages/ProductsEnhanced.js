        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
              High Recommended Products (Best Deals)
            </h3>
          </div>
          <span className="text-sm text-gray-500 dark:text-gray-400">Based on Price Difference & Incentive</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {recommendedProducts.map((product, index) => (
            <motion.div
              ...
              className="relative p-4 bg-gradient-to-br from-primary-50 to-orange-50 dark:from-primary-900/20 dark:to-orange-900/20 border-2 border-primary-200 dark:border-primary-700 rounded-xl hover:shadow-lg transition-all"
            >
              {/* Rank Badge */}
              <div className="absolute -top-3 -left-3 w-10 h-10 bg-gradient-to-br from-primary to-primary-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg">
                #{index + 1}
              </div>
